...
public class MainActivity extends AppCompatActivity {
    ...
    static final int MY_PERMISSIONS_REQUEST_WRITE_CONTACTS = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*callPermissionReadContacts();
        callPermissionWriteContacts();*/
    ...
    /*private void callPermissionReadContacts() {
    ...
    private void callPermissionWriteContacts() {
